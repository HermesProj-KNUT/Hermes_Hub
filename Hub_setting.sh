...
apt install bluetooth blueman bluez python3-bluetooth libbluetooth-dev libreadline-gplv2-dev libncursesw5-dev libsqlite3-dev tk-dev libgdbm-dev libc6-dev libbz2-dev fonts-unfonts-core  libasound2-dev
pip3 install pybluez pybleno
apt install pavucontrol vim
...
apt install matchbox-keyboard mpg321
